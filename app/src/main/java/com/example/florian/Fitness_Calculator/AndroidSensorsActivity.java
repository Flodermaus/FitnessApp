...
//                "Orientation Z (Yaw) :"+ Float.toString(gyroZ));
    ...
    public void save(String fileName){
        ...
        data4MachineLearning =  "@RELATION fittness              \n" +
                "                                \n" +
        ...
        for(int i=0; i<sensorData.size(); i++){
            if(i != 0 && i % 6 == 0) {
                data4MachineLearning += label + "\n";
            }
            data4MachineLearning += sensorData.get(i) + ",";
        }

        try {
            FileOutputStream fos = openFileOutput("Exercise.arff", Context.MODE_PRIVATE);
            fos.write(data4MachineLearning.getBytes());
            fos.close();
            ...
            if(file.exists()) {
                ...
                inputString = stringBuffer.toString() + data4MachineLearning;
                ...
                FileOutputStream fos2 = new FileOutputStream(file);
                fos2.write(data4MachineLearning.getBytes());
                fos2.close();
            }
